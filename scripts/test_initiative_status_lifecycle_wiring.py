...
def main() -> int:
    ...
    print('ok: lifecycle wiring emits create/update/finalize around initiative activation, subtask start, merge blocking, and terminal closure without forking duplicate status messages')
    return 0
